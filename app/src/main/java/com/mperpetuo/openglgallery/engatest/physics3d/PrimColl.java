...
import static com.mperpetuo.openglgallery.enga.VECQuat.quatrots;

import com.mperpetuo.openglgallery.engatest.physics3d.Physics3d.phyobject;

/**
 * Created by cyberrickers on 11/13/2016.
 */

public class PrimColl {
...
*/
    ...
    static void checkw(phyobject p) {
        int j;
        if (!p.haswf) {
    ...
    static float meshplane(phyobject p, VEC ploc, VEC pnorm, VEC cloc) {
        float dot;
